package com.brainycode.lab00.classic.helloworld;

/**
 * Below is a sample example that demonstrates the use of classic API.
 * It creates a simple text message and sends it to a Queue.
 * The same message is then read by a message consumer from the same queue.
 */
...
public class TestHelloWorldQueue {
    ...
    public static void main(String[] args) throws NamingException, JMSException {
        ...
        try {
            ...
            // Step-1 Create ConnectionFactory using JNDI lookup
            ConnectionFactory connectionFactory =
                    (ConnectionFactory) initialContext.lookup("jms/__defaultConnectionFactory");

            // Step-2 Create connection, get the Connection object from the ConnectionFactory
